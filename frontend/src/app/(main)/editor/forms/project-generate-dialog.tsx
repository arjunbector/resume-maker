...
interface ProjectGenerateDialogProps {
  open: boolean;
  onClose: (open: boolean) => void;
}
export default function ProjectGenerateDialog({
  onClose,
  open,
}: ProjectGenerateDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Generate Project Details</DialogTitle>
        </DialogHeader>
        <div>
          <Form {...form}>
            <form
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormControl>
                      <Textarea
                        {...field}
                        placeholder="For example: I made a project named MyAI to make AI tools easily accessible."
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
