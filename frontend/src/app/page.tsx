          ...
          <div className="text-center space-y-8">
            <div className="space-y-6 animate-fade-in-up">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                Leverage AI to create ATS-optimized resumes by aggregating data
                from LinkedIn, GitHub, and other platforms. Get personalized
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1 hover-lift">
              <CardHeader>
                ...
                <CardDescription>
                  Advanced NLP models analyze job descriptions and optimize your
                  resume content for maximum relevance.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1 hover-lift">
              <CardHeader>
                ...
                <CardDescription>
                  Seamlessly import data from LinkedIn, GitHub, and other
                  professional platforms to build comprehensive profiles.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1 hover-lift">
              <CardHeader>
                ...
                <CardDescription>
                  ...
                  with intelligent keyword matching and formatting.
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1 hover-lift">
              <CardHeader>
                ...
                <CardDescription>
                  Get instant feedback on your resume's performance and
            ...
            <Card className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1 hover-lift">
              <CardHeader>
                ...
                <CardDescription>
                  Export your resume in PDF, Word, and other formats with
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-xl text-muted-foreground">
                  Built with cutting-edge AI technology to give you the
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4 group">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Our NLP models understand context and meaning, not just
                      keywords, ensuring your resume resonates with hiring
                      managers.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4 group">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Stay ahead with up-to-date job market trends and
                      requirements to tailor your resume accordingly.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4 group">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Get tailored suggestions for skill development and career
                      advancement based on your profile and goals.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="hover-lift">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  "ResumeAI helped me land my dream job! The AI analysis was
                  spot-on and the ATS optimization made all the difference."
                </p>
            ...
            <Card className="hover-lift">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  "The platform integration with LinkedIn saved me hours of
                  work. My resume was ready in minutes, not days."
                </p>
            ...
            <Card className="hover-lift">
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4">
                  "The real-time feedback and analytics helped me understand
                  exactly what recruiters are looking for."
                </p>
        ...
        <div className="container mx-auto max-w-4xl text-center">
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
                className="group px-8 py-3 text-lg animate-pulse-glow"
                asChild
              >
